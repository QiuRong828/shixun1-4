  ...
  methods: {
    ...
    async handleGetUserList() {
      try {
        ...
        const response = await UserManagerApi.userListApi(data)
    ...
    async handleGetRoleList() {
      try {
        ...
        const response = await RoleManagerApi.roleListAPI(data)
    ...
    async handleSubmitAddData() {
      ...
      await UserManagerApi.addUserApi(this.UserDialogForm)
    ...
    async handleFindUser(id) {
      const response = await UserManagerApi.userInfoIdAPI(id)
    ...
    async handleUpdateUser() {
      const response = await UserManagerApi.updateUserApi(this.UserDialogForm)
    ...
    handleSubmitRole() {
      this.$refs.roleDialogForm.validate(async (valid) => {
        if (valid) {
          const response = await RoleManagerApi.roleEditAPI(
            this.roleId,
            this.roleForm.roleId
          )
